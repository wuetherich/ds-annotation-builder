...
public class SCR_1_0_ComponentDescription extends AbstractComponentDescription {
   ...
   */
  public SCR_1_0_ComponentDescription(TypeDeclaration typeDeclaration) {
  ...
  public String getActivate() {
    throw new DsAnnotationException("Explicit activate methods are not supported in DS 1.0.");
  }
  ...
  public String getDeactivate() {
    throw new DsAnnotationException("Explicit deactivate methods are not supported in DS 1.0.");
  }
  ...
  public void onSetModified(String methodName) {
    throw new DsAnnotationException("Explicit modified methods are not supported in DS 1.0.");
  }
  ...
  public void onSetConfigurationPolicy(String lowerCase) {
    throw new DsAnnotationException("The attribute 'configurationPolicy' is not supported in DS 1.0.");
  }

  @Override
  public void onSetConfigurationPid(String configurationPid) {
    throw new DsAnnotationException("The attribute 'configurationPid' is not supported in DS 1.0.");
  }
  ...
  public void onAddReference(String service, String bind, String name, String cardinality, String policy,
    ...
    if (isNotEmpty(policyOption)) {
      throw new DsAnnotationException("Attribute 'policyOption' methods is not supported in DS 1.0.");
    }
