...
import org.eclipse.pde.ds.annotations.internal.builder.AbstractDsAnnotationAstVisitor;
import org.eclipse.pde.ds.annotations.internal.builder.ComponentProperty;
 ...
 */
public class SCR_1_2_ComponentDescription extends AbstractComponentDescription {
  ...
  /**
   * <p>
   * Creates a new instance of type {@link SCR_1_2_ComponentDescription extends AbstractComponentDescription}.
   * </p>
   * 
   * @param typeAccessor
   */
  ...
  public void onAddReference(String service, String bind, String name, String cardinality, String policy,
    ...
    if (isNotEmpty(updated)) {
      ...
      //
      String computedUpdatedMethodName = AbstractDsAnnotationAstVisitor.computeUpdatedMethodName(bind);
